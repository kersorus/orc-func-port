...
void audiomixer_orc_volume_u8_sse (guint8 * ORC_RESTRICT d1, int p1, int n);
void audiomixer_orc_add_volume_u8_sse (guint8 * ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1, int p1, int n);
void audiomixer_orc_add_volume_s8_sse (gint8 * ORC_RESTRICT d1, const gint8 * ORC_RESTRICT s1, int p1, int n);
